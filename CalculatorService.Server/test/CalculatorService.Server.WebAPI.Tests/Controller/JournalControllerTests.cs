...
namespace CalculatorService.Server.WebAPI.Tests.Controller
{
  public class JournalControllerTests : IClassFixture<TestApplication>
  {
    ...
    /// <summary>
    /// Test Case: Return an empty List if there is nothing in saved on Database.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Test Case: Return only one element if there is only one element saved in the database for a given trackingId
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Test Case: Return two elements if there is two elements saved in the database for a given trackingId
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Test case: If the Tracking Id is missing return BadRequest
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Test Case: When there was an internal error, throw Internal Server Error.
    /// </summary>
    [Fact]
